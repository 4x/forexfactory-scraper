...
async def scrape_incremental(from_date, to_date, output_csv, tzname,
    ...
    await scrape_range_pandas(from_date, to_date,
        output_csv, tzname=tzname, scrape_details=scrape_details)
